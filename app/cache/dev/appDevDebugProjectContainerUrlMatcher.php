...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // chart
        if ('/chart' === $pathinfo) {
            return array (  '_controller' => 'AppBundle\\Controller\\ChartController::chartAction',  '_route' => 'chart',);
        }
        ...
        // calendar
        if ('/cal' === $pathinfo) {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::calAction',  '_route' => 'calendar',);
        }
        ...
        if (0 === strpos($pathinfo, '/fullcalendar')) {
            ...
            if ('/fullcalendar/load' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\CalendarController::loadAction',  '_route' => 'fullcalendar_loadevents',);
            }

            // fullcalendar_changedate
            if ('/fullcalendar/change' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\CalendarController::changeAction',  '_route' => 'fullcalendar_changedate',);
            }

            // fullcalendar_resizedate
            if ('/fullcalendar/resize' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\CalendarController::resizeAction',  '_route' => 'fullcalendar_resizedate',);
            }
