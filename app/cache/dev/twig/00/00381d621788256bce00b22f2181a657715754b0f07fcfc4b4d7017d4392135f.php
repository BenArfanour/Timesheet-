...
class __TwigTemplate_91db4ae3cb5810430e5c4fc2f365ff58f3133536e75cd463c84444e8ba1cf5b4 extends Twig_Template
{
...
($context["id"] ?? $this->getContext($context, "id")), "subclass" => $this->getAttribute($this->getAttribute(            // line 305
($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "admin", array()), "getActiveSubclassCode", array(), "method"), "objectId" => $this->getAttribute($this->getAttribute($this->getAttribute(            // line 306
($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "admin", array()), "root", array()), "id", array(0 => $this->getAttribute($this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "admin", array()), "root", array()), "subject", array())), "method"), "uniqid" => $this->getAttribute($this->getAttribute($this->getAttribute(            // line 307
($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "admin", array()), "root", array()), "uniqid", array()), "code" => $this->getAttribute($this->getAttribute($this->getAttribute(            // line 308
...
($context["associationadmin"] ?? $this->getContext($context, "associationadmin")), "uniqid", array()), "code" => $this->getAttribute(            // line 468
($context["associationadmin"] ?? $this->getContext($context, "associationadmin")), "code", array()), "linkParameters" => $this->getAttribute($this->getAttribute($this->getAttribute(            // line 469
($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "field_description", array()), "options", array()), "link_parameters", array())));
            ...
            ";
            // line 477
            if (($context["btn_edit"] ?? $this->getContext($context, "btn_edit"))) {
                // line 478
                echo "                var edit_button_url = '";
                echo $this->getAttribute(                // line 479
($context["associationadmin"] ?? $this->getContext($context, "associationadmin")), "generateUrl", array(0 => "edit", 1 => array("id" => "OBJECT_ID")), "method");
                // line 480
                echo "'.replace('OBJECT_ID', jQuery(this).val());
...
{% endautoescape %}
", "SonataAdminBundle:CRUD/Association:edit_many_script.html.twig", "/var/www/html/timesheet/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/Association/edit_many_script.html.twig");
    }
}
