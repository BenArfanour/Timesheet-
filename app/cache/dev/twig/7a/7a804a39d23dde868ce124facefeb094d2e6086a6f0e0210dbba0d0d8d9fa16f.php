...
class __TwigTemplate_f546dcf067aa6ba9cbfaad76ec3ffe161b3bc5d1042d45b6f0122f453f11e1e2 extends Twig_Template
{
    ...
    {
        // line 12
        return $this->loadTemplate($this->env->getExtension('Sonata\AdminBundle\Twig\Extension\TemplateRegistryExtension')->getAdminTemplate("base_list_field", $this->getAttribute(($context["admin"] ?? $this->getContext($context, "admin")), "code", array())), "SonataAdminBundle:CRUD:list_datetime.html.twig", 12);
    }
...
{% block field %}
    ...
    {%- endif -%}
{% endblock %}
", "SonataAdminBundle:CRUD:list_datetime.html.twig", "/var/www/html/timesheet/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/list_datetime.html.twig");
    }
}
