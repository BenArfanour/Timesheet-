...
class __TwigTemplate_8c48df6d357bca145e7f424f52895d52951f803b806e0a7d89408e06b6c6f7bc extends Twig_Template
{
    ...
    <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["revision"]) {
            ...
            echo "</td>
                                <td>";
            // line 38
            $this->loadTemplate($this->env->getExtension('Sonata\AdminBundle\Twig\Extension\TemplateRegistryExtension')->getAdminTemplate("history_revision_timestamp", $this->getAttribute(($context["admin"] ?? $this->getContext($context, "admin")), "code", array())), "SonataAdminBundle:CRUD:base_history.html.twig", 38)->display($context);
            echo "</td>
                                <td>";
            // line 39
...
{% endblock %}
", "SonataAdminBundle:CRUD:base_history.html.twig", "/var/www/html/timesheet/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/base_history.html.twig");
    }
}
