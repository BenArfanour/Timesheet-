...
class __TwigTemplate_74e659395989f75404b885d4094c6ca97abfaa90da9051538cf4c02d71ac14d5 extends Twig_Template
{
    ...
    {
        // line 1
        return $this->loadTemplate($this->env->getExtension('Sonata\AdminBundle\Twig\Extension\TemplateRegistryExtension')->getAdminTemplate("base_list_field", $this->getAttribute(($context["admin"] ?? $this->getContext($context, "admin")), "code", array())), "SonataAdminBundle:CRUD:list_html.html.twig", 1);
    }
...
{% block field %}
    ...
    {% endif %}
{% endblock %}
", "SonataAdminBundle:CRUD:list_html.html.twig", "/var/www/html/timesheet/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/list_html.html.twig");
    }
}
