...
class __TwigTemplate_b73a9f103da8119ff65db4bbafd4dba3f903d8474983233192076ea80b982395 extends Twig_Template
{
    ...
    {
        // line 12
        return $this->loadTemplate($this->env->getExtension('Sonata\AdminBundle\Twig\Extension\TemplateRegistryExtension')->getAdminTemplate("base_list_field", $this->getAttribute(($context["admin"] ?? $this->getContext($context, "admin")), "code", array())), "@SonataAdmin/CRUD/list_boolean.html.twig", 12);
    }
...
{% endblock %}
", "@SonataAdmin/CRUD/list_boolean.html.twig", "/var/www/html/timesheet/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/list_boolean.html.twig");
    }
}
