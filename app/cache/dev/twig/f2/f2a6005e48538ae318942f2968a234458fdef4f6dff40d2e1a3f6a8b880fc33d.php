...
class __TwigTemplate_489cad4a7b03ed3dd456c719bfe51811d7879dac2ed0143cd0a75decdb4b8f73 extends Twig_Template
{
...
($context["field_description"] ?? $this->getContext($context, "field_description")), "associationadmin", array()), "id", array(0 => ($context["value"] ?? $this->getContext($context, "value"))), "method")) && $this->getAttribute($this->getAttribute(        // line 20
...
($context["field_description"] ?? $this->getContext($context, "field_description")), "associationadmin", array()), "hasAccess", array(0 => ($context["route_name"] ?? $this->getContext($context, "route_name")), 1 => ($context["value"] ?? $this->getContext($context, "value"))), "method"))) {
    ...
    {
        return array (  60 => 26,  54 => 23,  49 => 22,  47 => 21,  46 => 20,  45 => 19,  43 => 18,  40 => 17,  34 => 16,  11 => 12,);
    }
...
{% block field %}
    ...
    {% endif %}
{% endblock %}
", "SonataDoctrineORMAdminBundle:CRUD:show_orm_one_to_one.html.twig", "/var/www/html/timesheet/vendor/sonata-project/doctrine-orm-admin-bundle/src/Resources/views/CRUD/show_orm_one_to_one.html.twig");
    }
}
