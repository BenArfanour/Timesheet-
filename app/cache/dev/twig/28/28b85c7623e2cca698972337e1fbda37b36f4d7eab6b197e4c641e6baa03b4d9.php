...
class __TwigTemplate_fac1e1f4793dda646431dabe01041d8639990ee2230426404ffadd839fdcd710 extends Twig_Template
{
    ...
    ";
            ...
            if ((array_key_exists("empty_value", $context) &&  !(null === ($context["empty_value"] ?? $this->getContext($context, "empty_value"))))) {
                ...
                echo ">
                    ";
                // line 216
                if ((($context["empty_value"] ?? $this->getContext($context, "empty_value")) != "")) {
                    // line 217
                    echo "                        ";
                    if ( !$this->getAttribute(($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "admin", array())) {
                        // line 218
...
array_key_exists("placeholder", $context) &&  !(null === ($context["placeholder"] ?? $this->getContext($context, "placeholder"))))) {
                ...
                echo ">
                    ";
                // line 226
                if ((($context["placeholder"] ?? $this->getContext($context, "placeholder")) != "")) {
                    // line 227
                    echo "                        ";
                    if ( !$this->getAttribute(($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "admin", array())) {
                        // line 228
    ...
    ";
            ...
            ";
            // line 259
            echo twig_replace_filter(($context["date_pattern"] ?? $this->getContext($context, "date_pattern")), array("{{ year }}" => (((("<div class=\"" .             // line 260
($context["input_wrapper_class"] ?? $this->getContext($context, "input_wrapper_class"))) . "\">") . $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "year", array()), 'widget')) . "</div>"), "{{ month }}" => (((("<div class=\"" .             // line 261
($context["input_wrapper_class"] ?? $this->getContext($context, "input_wrapper_class"))) . "\">") . $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "month", array()), 'widget')) . "</div>"), "{{ day }}" => (((("<div class=\"" .             // line 262
...
";
    ...
    public function block_sonata_type_immutable_array_widget_row($context, array $blocks = array())
    {
        ...
        // line 463
        echo "                ";
        $context["sonata_help"] = $this->getAttribute($this->getAttribute(($context["child"] ?? $this->getContext($context, "child")), "vars", array()), "sonata_help", array());
        // line 464
        echo "                ";
        $this->displayBlock("sonata_help", $context, $blocks);
        echo "
    ...
    public function block_sonata_type_model_autocomplete_widget($context, array $blocks = array())
    {
        ...
        // line 477
        echo "    ";
        $this->loadTemplate(($context["template"] ?? $this->getContext($context, "template")), "@SonataAdmin/Form/form_admin_fields.html.twig", 477)->display($context);
    ...
    ";
        ...
        if (($context["expanded"] ?? $this->getContext($context, "expanded"))) {
            // line 485
            echo "        ";
            $context["js_selector"] = (((("#" . ($context["main_form_name"] ?? $this->getContext($context, "main_form_name"))) . "_") . ($context["name"] ?? $this->getContext($context, "name"))) . " input");
            // line 486
            echo "        ";
            ...
            // line 488
            echo "        ";
            $context["js_selector"] = ((("#" . ($context["main_form_name"] ?? $this->getContext($context, "main_form_name"))) . "_") . ($context["name"] ?? $this->getContext($context, "name")));
            // line 489
            echo "        ";
        ...
        // line 495
        echo twig_escape_filter($this->env, ($context["js_selector"] ?? $this->getContext($context, "js_selector")), "html", null, true);
        echo "\");

            showMaskChoiceEl.on(\"";
        // line 497
        echo twig_escape_filter($this->env, ($context["js_event"] ?? $this->getContext($context, "js_event")), "html", null, true);
        echo "\", function () {
