...
class __TwigTemplate_771df060f0cc26f218c07e68f69c363ece379c3f02f7929e858fd43e7fc9a957 extends Twig_Template
{
    ...
    public function block_block($context, array $blocks = array())
    {
        ...
        ";
        // line 15
        if ( !twig_test_empty($this->getAttribute(($context["settings"] ?? $this->getContext($context, "settings")), "title", array()))) {
            // line 16
            echo "            <div class=\"panel-heading\">
                <h4 class=\"panel-title\">
                    ";
            // line 18
            if ($this->getAttribute(($context["settings"] ?? $this->getContext($context, "settings")), "icon", array())) {
                // line 19
                echo "                        <i class=\"";
            ...
            // line 21
            echo "                    ";
            if ($this->getAttribute(($context["settings"] ?? $this->getContext($context, "settings")), "translation_domain", array())) {
                // line 22
                echo "                        ";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans($this->getAttribute(($context["settings"] ?? $this->getContext($context, "settings")), "title", array()), array(), $this->getAttribute(($context["settings"] ?? $this->getContext($context, "settings")), "translation_domain", array())), "html", null, true);
                echo "
                    ";
            } else {
                // line 24
...
{% endblock %}
", "SonataBlockBundle:Block:block_core_rss.html.twig", "/var/www/html/timesheet/vendor/sonata-project/block-bundle/src/Resources/views/Block/block_core_rss.html.twig");
    }
}
