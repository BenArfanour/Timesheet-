...
class __TwigTemplate_4e16d3b990bab6b5a55a87ad2e7b43e02c5d11d27c754cb035518b431f16ec97 extends Twig_Template
{
    ...
    <input type=\"text\" id=\"";
        ...
        // line 15
        if (((array_key_exists("read_only", $context)) ? (_twig_default_filter(($context["read_only"] ?? $this->getContext($context, "read_only")), false)) : (false))) {
    ...
    ";
        // line 40
        if (($this->getAttribute(($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "field_description", array()) && $this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "field_description", array()), "hasAssociationAdmin", array()))) {
            // line 41
...
($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "field_description", array()), "associationadmin", array()), "isGranted", array(0 => "CREATE"), "method")) && ($context["btn_add"] ?? $this->getContext($context, "btn_add")));
            // line 44
            echo "            ";
            if (($context["display_btn_add"] ?? $this->getContext($context, "display_btn_add"))) {
                // line 45
                echo "                <a  href=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "field_description", array()), "associationadmin", array()), "generateUrl", array(0 => "create", 1 => $this->getAttribute($this->getAttribute(                // line 46
($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "field_description", array()), "getOption", array(0 => "link_parameters", 1 => array()), "method")), "method"), "html", null, true);
    ...
    <script>
        ...
        // line 74
        echo "placeholder: '";
        echo twig_escape_filter($this->env, ((($context["placeholder"] ?? $this->getContext($context, "placeholder"))) ? (($context["placeholder"] ?? $this->getContext($context, "placeholder"))) : (($context["allowClearPlaceholder"] ?? $this->getContext($context, "allowClearPlaceholder")))), "js", null, true);
        ...
        echo ",
                readonly: ";
        // line 77
        echo (((((array_key_exists("read_only", $context)) ? (_twig_default_filter(($context["read_only"] ?? $this->getContext($context, "read_only")), false)) : (false)) || (($this->getAttribute(($context["attr"] ?? null), "read_only", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["attr"] ?? null), "read_only", array()), false)) : (false)))) ? ("true") : ("false"));
        echo ", ";
        // line 78
        echo "                ";
        echo "    ";
        ...
        echo twig_escape_filter($this->env, ($context["minimum_input_length"] ?? $this->getContext($context, "minimum_input_length")), "js", null, true);
        echo ",
                multiple: ";
        // line 80
        ...
        echo ",
                containerCssClass: '";
        // line 87
        echo twig_escape_filter($this->env, (($context["container_css_class"] ?? $this->getContext($context, "container_css_class")) . " form-control"), "js", null, true);
        echo "',
                dropdownCssClass: '";
        // line 88
        echo twig_escape_filter($this->env, ($context["dropdown_css_class"] ?? $this->getContext($context, "dropdown_css_class")), "js", null, true);
        echo "',
                ajax: {
                    url:  '";
        // line 90
        echo twig_escape_filter($this->env, ((($context["url"] ?? $this->getContext($context, "url"))) ? (($context["url"] ?? $this->getContext($context, "url"))) : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath($this->getAttribute(($context["route"] ?? $this->getContext($context, "route")), "name", array()), (($this->getAttribute(($context["route"] ?? null), "parameters", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["route"] ?? null), "parameters", array()), array())) : (array()))))), "js", null, true);
        echo "',
                    dataType: 'json',
                    quietMillis: ";
        // line 92
        echo twig_escape_filter($this->env, ($context["quiet_millis"] ?? $this->getContext($context, "quiet_millis")), "js", null, true);
        echo ",
                    cache: ";
        // line 93
        ...
        if (($context["multiple"] ?? $this->getContext($context, "multiple"))) {
            ...
            echo twig_escape_filter($this->env, ($context["full_name"] ?? $this->getContext($context, "full_name")), "js", null, true);
            echo "[]\" value=\"'+el.id+'\" />');
                        }";
        } else {
            // line 247
        ...
        if ( !twig_test_empty(($context["value"] ?? $this->getContext($context, "value")))) {
            ...
            foreach ($context['_seq'] as $context["idx"] => $context["val"]) {
                if ((($context["idx"] . "") != "_labels")) {
                    ...
                    echo "', label:'";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["value"] ?? $this->getContext($context, "value")), "_labels", array(), "array"), $context["idx"], array(), "array"), "js", null, true);
                    echo "'}";
                    ++$context['loop']['index0'];
                    ++$context['loop']['index'];
...
";
    ...
    public function block_sonata_type_model_autocomplete_ajax_request_parameters($context, array $blocks = array())
    {
        ...
        echo "                        return {
                                ...
                                '";
        // line 105
        echo twig_escape_filter($this->env, ($context["req_param_name_search"] ?? $this->getContext($context, "req_param_name_search")), "js", null, true);
        echo "': term,

                                // page size
                                '";
        // line 108
        echo twig_escape_filter($this->env, ($context["req_param_name_items_per_page"] ?? $this->getContext($context, "req_param_name_items_per_page")), "js", null, true);
        echo "': ";
        echo twig_escape_filter($this->env, ($context["items_per_page"] ?? $this->getContext($context, "items_per_page")), "js", null, true);
        echo ",

                                // page number
                                '";
        // line 111
        echo twig_escape_filter($this->env, ($context["req_param_name_page_number"] ?? $this->getContext($context, "req_param_name_page_number")), "js", null, true);
        echo "': page,
        ...
        if ( !(null === $this->getAttribute(($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "admin", array()))) {
            // line 115
            echo "                                    'uniqid': '";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "admin", array()), "uniqid", array()), "js", null, true);
            echo "',
                                    'admin_code': '";
            // line 116
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? $this->getContext($context, "sonata_admin")), "admin", array()), "code", array()), "js", null, true);
            echo "',
                                ";
        } elseif (        // line 117
($context["admin_code"] ?? $this->getContext($context, "admin_code"))) {
            // line 118
            echo "                                    'admin_code':  '";
            echo twig_escape_filter($this->env, ($context["admin_code"] ?? $this->getContext($context, "admin_code")), "js", null, true);
            echo "',
                                ";
        }
        // line 120
        ...
        if ($this->getAttribute($this->getAttribute($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "request", array()), "query", array()), "get", array(0 => "subclass"), "method")) {
            // line 123
            echo "                                    'subclass': '";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "request", array()), "query", array()), "get", array(0 => "subclass"), "method"), "js", null, true);
            echo "',
                                ";
        }
        // line 125
        ...
        if ((($context["context"] ?? $this->getContext($context, "context")) == "filter")) {
            // line 127
            echo "                                    'field':  '";
            echo twig_escape_filter($this->env, twig_replace_filter(($context["full_name"] ?? $this->getContext($context, "full_name")), array("filter[" => "", "][value]" => "", "__" => ".")), "js", null, true);
            echo "',
                                    '_context': 'filter'
                                ";
        } else {
            // line 130
            echo "                                    'field':  '";
            echo twig_escape_filter($this->env, ($context["name"] ?? $this->getContext($context, "name")), "js", null, true);
            echo "'
                                ";
        }
        // line 132
    ...
    public function block_sonata_type_model_autocomplete_dropdown_item_format($context, array $blocks = array())
    {
        ...
        // line 151
        if (((array_key_exists("safe_label", $context)) ? (_twig_default_filter(($context["safe_label"] ?? $this->getContext($context, "safe_label")), false)) : (false))) {
            // line 152
            echo "                        '<div class=\"";
            echo twig_escape_filter($this->env, ($context["dropdown_item_css_class"] ?? $this->getContext($context, "dropdown_item_css_class")), "js", null, true);
            echo "\">'+item.label+'<\\/div>'
                    ";
        } else {
            // line 154
...
{% endspaceless %}
", "SonataAdminBundle:Form/Type:sonata_type_model_autocomplete.html.twig", "/var/www/html/timesheet/vendor/sonata-project/admin-bundle/src/Resources/views/Form/Type/sonata_type_model_autocomplete.html.twig");
    }
}
