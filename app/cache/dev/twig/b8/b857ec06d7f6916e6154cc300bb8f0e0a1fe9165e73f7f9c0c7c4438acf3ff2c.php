...
class __TwigTemplate_23c7dea32c0a2e5acb3110cc907b19e549ff9fda0fc47f9cf18af6fc9c43fd13 extends Twig_Template
{
    ...
    {
        // line 12
        return $this->loadTemplate($this->env->getExtension('Sonata\AdminBundle\Twig\Extension\TemplateRegistryExtension')->getAdminTemplate("base_list_field", $this->getAttribute(($context["admin"] ?? $this->getContext($context, "admin")), "code", array())), "SonataAdminBundle:CRUD:list_url.html.twig", 12);
    }
...
{% endspaceless %}
{% endblock %}
", "SonataAdminBundle:CRUD:list_url.html.twig", "/var/www/html/timesheet/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/list_url.html.twig");
    }
}
