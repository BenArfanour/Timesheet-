...
class __TwigTemplate_b52ead461d8acde80c0bcab64b7411e8a34727f4ba7a2c8a030739eca2834cd8 extends Twig_Template
{
    ...
    {
        // line 12
        return $this->loadTemplate($this->env->getExtension('Sonata\AdminBundle\Twig\Extension\TemplateRegistryExtension')->getAdminTemplate("base_list_field", $this->getAttribute(($context["admin"] ?? $this->getContext($context, "admin")), "code", array())), "SonataAdminBundle:CRUD:list_trans.html.twig", 12);
    }
...
{% endblock %}
", "SonataAdminBundle:CRUD:list_trans.html.twig", "/var/www/html/timesheet/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/list_trans.html.twig");
    }
}
